            ...
            return (
                <g key={i}>
                    ...
                    <g transform={`translate(${center}, ${center}) rotate(${rotateDeg})`}>
                        <text
                            x={210} // moved outward from center
                            y={0}
                            fill="white"
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#020617] via-[#020617] to-[#0f172a] overflow-hidden">
            ...
            <div className="text-center w-full max-w-7xl mx-auto px-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-500 mb-8 drop-shadow-lg tracking-tight mt-4">
                ...
                {!hasSpun ? (
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <div className="relative flex justify-center items-center w-full max-w-[80vw] lg:max-w-[800px] mb-8 lg:mb-12">
                        ...
                        <motion.button
                            ...
                            disabled={isSpinning}
                            onClick={spinWheel}
                            className="px-16 py-6 rounded-2xl bg-gradient-to-r from-cyan-500 to-indigo-600 text-white text-3xl font-bold shadow-[0_0_40px_rgba(34,211,238,0.5)] disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-widest"
                        >
                    ...
                    <AnimatePresence>
                        ...
                        >
                            ...
                            <p className="text-cyan-400 text-2xl lg:text-3xl uppercase tracking-widest font-black mb-10">
                                Your Fate
                            </p>

                            <div className="text-white text-4xl lg:text-6xl font-bold bg-black/40 rounded-3xl p-12 leading-tight border border-cyan-500/30 shadow-inner">
                                {result.topic}
                            </div>
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={resetWheel}
                                className="mt-16 px-12 py-5 rounded-2xl bg-gradient-to-r from-slate-700 to-slate-800 text-white text-2xl font-bold hover:from-slate-600 hover:to-slate-700 transition border border-white/10 shadow-lg"
                            >
                                Spin Again 🔄
                            </motion.button>
